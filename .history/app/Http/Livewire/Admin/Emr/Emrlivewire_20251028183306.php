...
public function show($emr_id, $showdatatype)
{
    ...
    if (!$this->firstClickOccurred) {
        // First click:
        $this->firstClickOccurred = true; // Set the flag to true for the next click
        
        // The event is NOT dispatched here, so the modal will not open.
        return; // Stop execution
    }

    // Second click and subsequent clicks:
    // The flag is true, so we proceed to load data and dispatch the event.
