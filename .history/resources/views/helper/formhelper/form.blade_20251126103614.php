...
<div class="{{ $col }} mb-3">
    ...
    <span class="text-danger fw-bold">*</span>
    @endif
    <input wire:model.lazy="{{ $fieldname }}" type="password" class="form-control" id="{{ $labelidname }}">
    @error($fieldname)
    <span class="text-danger">{{ $message }}</span>
    @enderror
</div>
...
<div class="{{ $col }} mb-3">
    ...
    @endif
    <div class="form-check form-switch">
        <input wire:model.lazy="{{ $fieldname }}" class="form-check-input" id="{{ $labelidname }}" type="checkbox"
