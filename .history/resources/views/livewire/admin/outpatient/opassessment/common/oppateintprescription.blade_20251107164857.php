<div class="col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            <div class="row g-2">
                <div class="dropdown">
                    <input type="text" class="form-control shadow-sm" placeholder="Search Drug..." wire:model.live.debounce.250ms="searchquery" />

                      <ul wire:loading.delay.short class="dropdown-menu list-group w-100"  style="display: {{ $searchquery ? 'block' : 'none' }}">
