            ...
            <div class="row g-2">
                <div class="dropdown">
                    ...
                    <ul
                        ...
                        class="dropdown-menu list-group w-100 mt-1 show"
                        style="z-index: 1055; position: absolute;">
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            Searching...
                        </li>
                    </ul>
                    <!-- <input type="text" class="form-control shadow-sm" placeholder="Search Drug..." wire:model.live.debounce.300ms="searchquery" />

                      <ul wire:loading   wire:target="searchquery" class="dropdown-menu list-group w-100"  style="display: {{ $searchquery ? 'block' : 'none' }}">
