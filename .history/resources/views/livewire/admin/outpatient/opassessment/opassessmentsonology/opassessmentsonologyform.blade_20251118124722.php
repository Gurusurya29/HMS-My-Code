                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-12">
                            <select wire:model="currentcomplaint" id="currentcomplaint"
                                class="form-select select2 currentcomplaint-dropdown" multiple>
                    ...
                    <div class="row g-2">
                        <div class="col-md-12">
                            <select wire:model="physicalexam" id="physicalexam"
                                class="form-select select2 physicalexam-dropdown" multiple>
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-12">
                            <select wire:model="diagnosismaster" id="diagnosismaster"
                                class="form-select select2 diagnosismaster-dropdown" multiple>
