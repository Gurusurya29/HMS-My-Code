...
<script>
    document.addEventListener('livewire:init', () => {
        ...
        // ✅ Generic reusable Select2 + Livewire sync initializer
        const initSelect2 = (selector, property) => {
            $(selector).each(function() {
                ...
                // ♻️ Sync Livewire → Select2 (for edit mode or updates)
                const currentVal = Livewire.find(compId).get(property);
                if (currentVal) {
                    $el.val(currentVal).trigger('change.select2');
                }

                // ⚡ Sync Select2 → Livewire instantly (no re-render)
        ...
        // ✅ Initialize all Select2 dropdowns with Livewire properties
        ...
        // 🔁 Reinitialize after Livewire updates DOM
