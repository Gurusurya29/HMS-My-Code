    ...
    document.addEventListener('livewire:init', () => {
        ...
        const initSelect2 = (selector, property) => {
            $(selector).each(function() {
                ...
                // Destroy existing Select2 (avoid duplicate dropdowns)
                if ($el.data('select2')) {
                    $el.select2('destroy');
                }
                ...
                $el.select2({
                    ...
                    allowClear: true,
                    dropdownParent: $el.parent(), // helps fix UI issues inside modals
                });
        ...
        const initializeAll = () => {
            selectMappings.forEach(({ selector, property }) => initSelect2(selector, property));
        };

        initializeAll();

        // Re-initialize after Livewire DOM updates (smooth and stable)
