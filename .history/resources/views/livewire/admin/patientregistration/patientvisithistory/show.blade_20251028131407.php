        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row text-dark p-2 shadow-sm border border-2 border-secondary rounded">
                    ...
                    'value' => $showdata->insurancecompany->name,
                    'columnone' => 'col-md-6',
                    'columntwo' => 'col-4',
                    'columnthree' => 'col-8',
                    ])
            ...
            <div class="modal-body">
                @if ($showdata)
                    <div class="row text-dark p-2 shadow-sm border border-2 border-secondary rounded">
                        ...
                        {{-- ====================== VITALS ====================== --}}
                        @foreach ([
                            'TEMPERATURE' => $showdata->temperature,
                            'BLOOD PRESSURE' => $showdata->bloodpressure,
                            'HEIGHT' => $showdata->height,
                            'WEIGHT' => $showdata->weight,
                            'PULSE RATE' => $showdata->pulserate,
                            'RESPIRATORY RATE' => $showdata->respiratoryrate,
                            'SpO2' => $showdata->spo_two,
                        ] as $label => $value)
                            @include('helper.formhelper.showlabel', [
                                'name' => $label,
                                'value' => $value,
                        ...
                        {{-- ====================== LIFESTYLE ====================== --}}
                        @foreach ([
                            'ALCOHOL' => $showdata->alcohol,
                            'SMOKING' => $showdata->smoking,
                            'TOBACCO' => $showdata->tobacco,
                        ] as $label => $val)
                            @include('helper.formhelper.showlabel', [
                                'name' => $label,
                                'value' => $val ? 'Yes' : 'No',
