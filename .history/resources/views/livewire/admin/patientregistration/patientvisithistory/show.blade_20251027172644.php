<div class="modal fade" id="showModal" data-bs-backdrop="static" data-bs-keyboard="false"
    tabindex="-1" aria-labelledby="showModalLabel" aria-hidden="true" wire:ignore.self>
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            @if ($showdata)
            <div class="modal-header text-white theme_bg_color px-3 py-2">
                <h5 class="modal-title" id="showModalLabel">
                    PATIENT VISIT DETAILS : {{ $showdata->uniqid }}
                </h5>
            ...
            <div class="modal-body">
                <div class="row text-dark p-2 shadow-sm border border-2 border-secondary rounded">
                    ...
                    'value' => $showdata->painscaleone ? (config('archive.pain_scale')[$showdata->painscaleone] ?? '') : '',
                    'columnone' => 'col-md-6',
                    'columntwo' => 'col-4',
                    'columnthree' => 'col-8',
                    ])
                    ...
                    @include('helper.formhelper.showlabel', [
                    'name' => 'CREATED AT',
                    'value' => optional($showdata->created_at)->format('d-m-Y h:i A'),
                    'columnone' => 'col-md-6',
                    'columntwo' => 'col-4',
                    'columnthree' => 'col-8',
                    ])
                    ...
                    @include('helper.formhelper.showlabel', [
                    'name' => 'UPDATED AT',
                    'value' => optional($showdata->updated_at)->format('d-m-Y h:i A'),
                    'columnone' => 'col-md-6',
                    'columntwo' => 'col-4',
                    'columnthree' => 'col-8',
                    ])
