<form wire:submit.prevent="store" enctype="multipart/form-data" class="bg-white shadow mt-2" autocomplete="off"
    ...
    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <select wire:model.lazy="doctor_id" class="form-select" id="select2-dropdown">
                                ...
                                <option value="{{ $eachdoctor->id }}"
                                    ...
                                    {{ $eachdoctor->name }} ({{ $eachdoctor->uniqid }})
                                </option>
                                @endforeach
                            </select>
                            @error('doctor_id')
        ...
        @include('livewire.admin.inpatient.ipnursingstation.common.ippatientlabinvestigation')
        @include('livewire.admin.inpatient.ipnursingstation.common.ippatientscaninvestigation')
        @include('livewire.admin.inpatient.ipnursingstation.common.ippatientxrayinvestigation')
        @include('livewire.admin.inpatient.ipnursingstation.common.ippateintprescription')
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function initAllSelects(root = document) {
            const selectMappings = [
                { selector: '#select2-dropdown', property: 'doctor_id' },
