...
<script>
    ...
    Livewire.on('showmodal', () => {
        if (isFirstShowModal) {
            // Log that the first click is being ignored and update the flag
            console.log("First 'View' button click ignored (as per requirement).");
            isFirstShowModal = false; // Set the flag so subsequent calls proceed
            return; // Exit the function, preventing the modal from opening
        }
        
        // If it's not the first click, proceed to show the modal
