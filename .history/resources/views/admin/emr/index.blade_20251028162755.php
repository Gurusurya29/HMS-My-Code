...
document.addEventListener('livewire:load', () => {
    // Utility function to safely show modal after Livewire updates
    ...
    Livewire.on('showModal', () => {
        // In Livewire v3, DOM updates are async — wait for them
        if (window.Livewire && Livewire.hook) {
            ...
            setTimeout(() => showModalSafely(), 150);
        }
    });
    ...
    // ✅ Print handlers (reuse same pattern)
