...
namespace App\Export\Admin\Reports\Inpatientreport\Completedsurgeryreport;
...
class CompletedsurgeryreportExport implements FromCollection, WithMapping, WithHeadings
{
    use Exportable;
    ...
    {
        return [['Completed Surgery Report'], [], [
            'PATIENT UHID',
            'PATIENT NAME',
            'PATIENT PHONE',
            'DOCTOR',
