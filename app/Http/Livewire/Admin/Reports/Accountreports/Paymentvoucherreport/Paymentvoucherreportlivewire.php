...
namespace App\Http\Livewire\Admin\Reports\Accountreports\Paymentvoucherreport;

use App\Export\Admin\Reports\Accountreport\Paymentvoucherreport\PaymentvoucherreportExport;
...
class Paymentvoucherreportlivewire extends Component
{
    ...
    public function export()
    {
        ...
        return Excel::download(new PaymentvoucherreportExport($paymentvoucher), 'paymentvoucher.xls');
    }

    public function pdf()
    {
        $paymentvoucher = $this->query()->get();
        $pdf = PDF::loadView('livewire.admin.reports.accountreports.paymentvoucherreport.paymentvoucherreportpdf', compact('paymentvoucher'))->output();
    ...
    protected function query()
    {
        ...
        return Paymentvoucher::whereBetween('created_at', [$this->from_date . " 00:00:00", $this->to_date . " 23:59:59"])
    ...
    public function render()
    {
        ...
        return view('livewire.admin.reports.accountreports.paymentvoucherreport.paymentvoucherreportlivewire', compact('paymentvoucher', 'totalpaidamount'));
    }
