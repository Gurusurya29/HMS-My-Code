...
namespace App\Http\Livewire\Admin\Outpatient\Opassessment\Opassessmentdiabetology;
...
class Opassessmentdiabetologylivewire extends Component
{
    ...
    public function store()
    {
        ...
        if ($this->labinvestigation_file) {
            $validatedData['labinvestigation_file'] = $this->uploadfile($this->outpatient->specialable ? $this->outpatient->specialable->id : null, $this->labinvestigation_file, '/admin/outpatient/' . $this->outpatient->uniqid, 'App\Models\Admin\Outpatient\Diabetology\Opdiabetology', 'labinvestigation_file');
        ...
        if ($this->scaninvestigation_file) {
            $validatedData['scaninvestigation_file'] = $this->uploadfile($this->outpatient->specialable ? $this->outpatient->specialable->id : null, $this->scaninvestigation_file, '/admin/outpatient/' . $this->outpatient->uniqid, 'App\Models\Admin\Outpatient\Diabetology\Opdiabetology', 'scaninvestigation_file');
        ...
        if ($this->xrayinvestigation_file) {
            $validatedData['xrayinvestigation_file'] = $this->uploadfile($this->outpatient->specialable ? $this->outpatient->specialable->id : null, $this->xrayinvestigation_file, '/admin/outpatient/' . $this->outpatient->uniqid, 'App\Models\Admin\Outpatient\Diabetology\Opdiabetology', 'xrayinvestigation_file');
        ...
        if ($this->prescription_file) {
            $validatedData['prescription_file'] = $this->uploadfile($this->outpatient->specialable ? $this->outpatient->specialable->id : null, $this->prescription_file, '/admin/outpatient/' . $this->outpatient->uniqid, 'App\Models\Admin\Outpatient\Diabetology\Opdiabetology', 'prescription_file');
        ...
        try {
            ...
            if ($this->outpatient->specialable) {
                $opdiabetology = $this->outpatient->specialable;
                $opdiabetology->update($validatedData);
                $this->user->opdiabetologyupdatable()->save($opdiabetology);

                $this->multiselectsync($opdiabetology);
                ...
                Helper::trackmessage($this->user, $opdiabetology, 'patientassesment_createoredit', session()->getId(), 'WEB', 'Patient Assessment Created');
                ...
                $opdiabetology = $this->user
                    ->opdiabetologycreatable()
                ...
                $this->outpatient->specialable()->associate($opdiabetology)
                    ->save();
                if ($this->is_movetoip) {
                    $inpatient = $this->user->inpatientcreatable()
                        ->create([
                ...
                Helper::trackmessage($this->user, $opdiabetology, 'patient_createoredit', session()->getId(), 'WEB', 'Patient Assessment Created');
    ...
    protected function multiselectsync($opdiabetology)
    {
        $opdiabetology->currentcomplaints()->sync($this->currentcomplaint);
        $opdiabetology->physicalexam()->sync($this->physicalexam);
        $opdiabetology->diagnosismaster()->sync($this->diagnosismaster);

        $this->labinvestigationsync($this->labinvestigation, $this->user, $this->outpatient->patient_id, $opdiabetology, 'OP', 'OP Diabetology', $this->is_labinvestigationemergency);
        $this->scaninvestigationsync($this->scaninvestigation, $this->user, $this->outpatient->patient_id, $opdiabetology, 'OP', 'OP Diabetology', $this->is_scaninvestigationemergency);
        $this->xrayinvestigationsync($this->xrayinvestigation, $this->user, $this->outpatient->patient_id, $opdiabetology, 'OP', 'OP Diabetology', $this->is_xrayinvestigationemergency);
    }
    ...
    {
        return view('livewire.admin.outpatient.opassessment.opassessmentdiabetology.opassessmentdiabetologylivewire');
    }
}
