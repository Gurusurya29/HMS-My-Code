...
namespace App\Http\Livewire\Admin\Outpatient\Opassessment\Opassessmentpaediatric;
...
class Opassessmentpaediatriclivewire extends Component
{
    ...
    public function store()
    {
        ...
        if ($this->labinvestigation_file) {
            $validatedData['labinvestigation_file'] = $this->uploadfile($this->outpatient->specialable ? $this->outpatient->specialable->id : null, $this->labinvestigation_file, '/admin/outpatient/' . $this->outpatient->uniqid, 'App\Models\Admin\Outpatient\Paediatric\Oppaediatric', 'labinvestigation_file');
        ...
        if ($this->scaninvestigation_file) {
            $validatedData['scaninvestigation_file'] = $this->uploadfile($this->outpatient->specialable ? $this->outpatient->specialable->id : null, $this->scaninvestigation_file, '/admin/outpatient/' . $this->outpatient->uniqid, 'App\Models\Admin\Outpatient\Paediatric\Oppaediatric', 'scaninvestigation_file');
        ...
        if ($this->xrayinvestigation_file) {
            $validatedData['xrayinvestigation_file'] = $this->uploadfile($this->outpatient->specialable ? $this->outpatient->specialable->id : null, $this->xrayinvestigation_file, '/admin/outpatient/' . $this->outpatient->uniqid, 'App\Models\Admin\Outpatient\Paediatric\Oppaediatric', 'xrayinvestigation_file');
        ...
        if ($this->prescription_file) {
            $validatedData['prescription_file'] = $this->uploadfile($this->outpatient->specialable ? $this->outpatient->specialable->id : null, $this->prescription_file, '/admin/outpatient/' . $this->outpatient->uniqid, 'App\Models\Admin\Outpatient\Paediatric\Oppaediatric', 'prescription_file');
        ...
        try {
            ...
            if ($this->outpatient->specialable) {
                $oppaediatric = $this->outpatient->specialable;
                $oppaediatric->update($validatedData);
                $this->user->oppaediatricupdatable()->save($oppaediatric);

                $this->multiselectsync($oppaediatric);
                ...
                Helper::trackmessage($this->user, $oppaediatric, 'patientassesment_createoredit', session()->getId(), 'WEB', 'Patient Assessment Created');
                ...
                $oppaediatric = $this->user
                    ->oppaediatriccreatable()
                ...
                $this->outpatient->specialable()->associate($oppaediatric)
                    ->save();
                if ($this->is_movetoip) {
                    $inpatient = $this->user->inpatientcreatable()
                        ->create([
                ...
                Helper::trackmessage($this->user, $oppaediatric, 'patient_createoredit', session()->getId(), 'WEB', 'Patient Assessment Created');
    ...
    protected function multiselectsync($oppaediatric)
    {
        $oppaediatric->currentcomplaints()->sync($this->currentcomplaint);
        $oppaediatric->physicalexam()->sync($this->physicalexam);
        $oppaediatric->diagnosismaster()->sync($this->diagnosismaster);

        $this->labinvestigationsync($this->labinvestigation, $this->user, $this->outpatient->patient_id, $oppaediatric, 'OP', 'OP Paediatric', $this->is_labinvestigationemergency);
        $this->scaninvestigationsync($this->scaninvestigation, $this->user, $this->outpatient->patient_id, $oppaediatric, 'OP', 'OP Paediatric', $this->is_scaninvestigationemergency);
        $this->xrayinvestigationsync($this->xrayinvestigation, $this->user, $this->outpatient->patient_id, $oppaediatric, 'OP', 'OP Paediatric', $this->is_xrayinvestigationemergency);
    }
    ...
    {
        return view('livewire.admin.outpatient.opassessment.opassessmentpaediatric.opassessmentpaediatriclivewire');
    }
}
