...
namespace App\Http\Livewire\Admin\Outpatient\Opassessment\Opassessmentcardiology;
...
class Opassessmentcardiologylivewire extends Component
{
    ...
    public function store()
    {
        ...
        if ($this->labinvestigation_file) {
            $validatedData['labinvestigation_file'] = $this->uploadfile($this->outpatient->specialable ? $this->outpatient->specialable->id : null, $this->labinvestigation_file, '/admin/outpatient/' . $this->outpatient->uniqid, 'App\Models\Admin\Outpatient\Cardiology\Opcardiology', 'labinvestigation_file');
        ...
        if ($this->scaninvestigation_file) {
            $validatedData['scaninvestigation_file'] = $this->uploadfile($this->outpatient->specialable ? $this->outpatient->specialable->id : null, $this->scaninvestigation_file, '/admin/outpatient/' . $this->outpatient->uniqid, 'App\Models\Admin\Outpatient\Cardiology\Opcardiology', 'scaninvestigation_file');
        ...
        if ($this->xrayinvestigation_file) {
            $validatedData['xrayinvestigation_file'] = $this->uploadfile($this->outpatient->specialable ? $this->outpatient->specialable->id : null, $this->xrayinvestigation_file, '/admin/outpatient/' . $this->outpatient->uniqid, 'App\Models\Admin\Outpatient\Cardiology\Opcardiology', 'xrayinvestigation_file');
        ...
        if ($this->prescription_file) {
            $validatedData['prescription_file'] = $this->uploadfile($this->outpatient->specialable ? $this->outpatient->specialable->id : null, $this->prescription_file, '/admin/outpatient/' . $this->outpatient->uniqid, 'App\Models\Admin\Outpatient\Cardiology\Opcardiology', 'prescription_file');
        ...
        try {
            ...
            if ($this->outpatient->specialable) {
                $opcardiology = $this->outpatient->specialable;
                $opcardiology->update($validatedData);
                $this->user->opcardiologyupdatable()->save($opcardiology);

                $this->multiselectsync($opcardiology);
                ...
                Helper::trackmessage($this->user, $opcardiology, 'patientassesment_createoredit', session()->getId(), 'WEB', 'Patient Assessment Created');
                ...
                $opcardiology = $this->user
                    ->opcardiologycreatable()
                ...
                $this->outpatient->specialable()->associate($opcardiology)
                    ->save();
                if ($this->is_movetoip) {
                    $inpatient = $this->user->inpatientcreatable()
                        ->create([
                ...
                Helper::trackmessage($this->user, $opcardiology, 'patient_createoredit', session()->getId(), 'WEB', 'Patient Assessment Created');
    ...
    protected function multiselectsync($opcardiology)
    {
        $opcardiology->currentcomplaints()->sync($this->currentcomplaint);
        $opcardiology->physicalexam()->sync($this->physicalexam);
        $opcardiology->diagnosismaster()->sync($this->diagnosismaster);

        $this->labinvestigationsync($this->labinvestigation, $this->user, $this->outpatient->patient_id, $opcardiology, 'OP', 'OP Cardiology', $this->is_labinvestigationemergency);
        $this->scaninvestigationsync($this->scaninvestigation, $this->user, $this->outpatient->patient_id, $opcardiology, 'OP', 'OP Cardiology', $this->is_scaninvestigationemergency);
        $this->xrayinvestigationsync($this->xrayinvestigation, $this->user, $this->outpatient->patient_id, $opcardiology, 'OP', 'OP Cardiology', $this->is_xrayinvestigationemergency);
    }
    ...
    {
        return view('livewire.admin.outpatient.opassessment.opassessmentcardiology.opassessmentcardiologylivewire');
    }
}
