...
namespace App\Http\Livewire\Admin\Outpatient\Opassessment\Opassessmentorthopedic;
...
class Opassessmentorthopediclivewire extends Component
{
    ...
    public function store()
    {
        ...
        if ($this->labinvestigation_file) {
            $validatedData['labinvestigation_file'] = $this->uploadfile($this->outpatient->specialable ? $this->outpatient->specialable->id : null, $this->labinvestigation_file, '/admin/outpatient/' . $this->outpatient->uniqid, 'App\Models\Admin\Outpatient\Ortho\Oporthopedic', 'labinvestigation_file');
        ...
        if ($this->scaninvestigation_file) {
            $validatedData['scaninvestigation_file'] = $this->uploadfile($this->outpatient->specialable ? $this->outpatient->specialable->id : null, $this->scaninvestigation_file, '/admin/outpatient/' . $this->outpatient->uniqid, 'App\Models\Admin\Outpatient\Ortho\Oporthopedic', 'scaninvestigation_file');
        ...
        if ($this->xrayinvestigation_file) {
            $validatedData['xrayinvestigation_file'] = $this->uploadfile($this->outpatient->specialable ? $this->outpatient->specialable->id : null, $this->xrayinvestigation_file, '/admin/outpatient/' . $this->outpatient->uniqid, 'App\Models\Admin\Outpatient\Ortho\Oporthopedic', 'xrayinvestigation_file');
        ...
        if ($this->prescription_file) {
            $validatedData['prescription_file'] = $this->uploadfile($this->outpatient->specialable ? $this->outpatient->specialable->id : null, $this->prescription_file, '/admin/outpatient/' . $this->outpatient->uniqid, 'App\Models\Admin\Outpatient\Ortho\Oporthopedic', 'prescription_file');
        ...
        try {
            ...
            if ($this->outpatient->specialable) {
                $oporthopedic = $this->outpatient->specialable;
                $oporthopedic->update($validatedData);
                $this->user->oporthopedicupdatable()->save($oporthopedic);
                $this->multiselectsync($oporthopedic);
                ...
                Helper::trackmessage($this->user, $oporthopedic, 'patientassesment_createoredit', session()->getId(), 'WEB', 'Patient Assessment Created');
                ...
                $oporthopedic = $this->user->oporthopediccreatable()
                ...
                $this->outpatient->specialable()->associate($oporthopedic)
                    ->save();
                if ($this->is_movetoip) {
                    $inpatient = $this->user->inpatientcreatable()
                        ->create([
                ...
                Helper::trackmessage($this->user, $oporthopedic, 'patient_createoredit', session()->getId(), 'WEB', 'Patient Assessment Created');
    ...
    protected function multiselectsync($oporthopedic)
    {
        $oporthopedic->currentcomplaints()->sync($this->currentcomplaint);
        $oporthopedic->physicalexam()->sync($this->physicalexam);
        $oporthopedic->diagnosismaster()->sync($this->diagnosismaster);

        $this->labinvestigationsync($this->labinvestigation, $this->user, $this->outpatient->patient_id, $oporthopedic, 'OP', 'OP Orthopedic', $this->is_labinvestigationemergency);
        $this->scaninvestigationsync($this->scaninvestigation, $this->user, $this->outpatient->patient_id, $oporthopedic, 'OP', 'OP Orthopedic', $this->is_scaninvestigationemergency);
        $this->xrayinvestigationsync($this->xrayinvestigation, $this->user, $this->outpatient->patient_id, $oporthopedic, 'OP', 'OP Orthopedic', $this->is_xrayinvestigationemergency);
    }
    ...
    {
        return view('livewire.admin.outpatient.opassessment.opassessmentorthopedic.opassessmentorthopediclivewire');
    }
}
