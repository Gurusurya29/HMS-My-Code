...
namespace App\Http\Livewire\Admin\Outpatient\Opassessment\Opassessmentanesthesiology;
...
class Opassessmentanesthesiologylivewire extends Component
{
    ...
    public function store()
    {
        ...
        if ($this->labinvestigation_file) {
            $validatedData['labinvestigation_file'] = $this->uploadfile($this->outpatient->specialable ? $this->outpatient->specialable->id : null, $this->labinvestigation_file, '/admin/outpatient/' . $this->outpatient->uniqid, 'App\Models\Admin\Outpatient\Anesthesiology\Opanesthesiology', 'labinvestigation_file');
        ...
        if ($this->scaninvestigation_file) {
            $validatedData['scaninvestigation_file'] = $this->uploadfile($this->outpatient->specialable ? $this->outpatient->specialable->id : null, $this->scaninvestigation_file, '/admin/outpatient/' . $this->outpatient->uniqid, 'App\Models\Admin\Outpatient\Anesthesiology\Opanesthesiology', 'scaninvestigation_file');
        ...
        if ($this->xrayinvestigation_file) {
            $validatedData['xrayinvestigation_file'] = $this->uploadfile($this->outpatient->specialable ? $this->outpatient->specialable->id : null, $this->xrayinvestigation_file, '/admin/outpatient/' . $this->outpatient->uniqid, 'App\Models\Admin\Outpatient\Anesthesiology\Opanesthesiology', 'xrayinvestigation_file');
        ...
        if ($this->prescription_file) {
            $validatedData['prescription_file'] = $this->uploadfile($this->outpatient->specialable ? $this->outpatient->specialable->id : null, $this->prescription_file, '/admin/outpatient/' . $this->outpatient->uniqid, 'App\Models\Admin\Outpatient\Anesthesiology\Opanesthesiology', 'prescription_file');
        ...
        try {
            ...
            if ($this->outpatient->specialable) {
                $opanesthesiology = $this->outpatient->specialable;
                $opanesthesiology->update($validatedData);
                $this->user->opanesthesiologyupdatable()->save($opanesthesiology);

                $this->multiselectsync($opanesthesiology);
                ...
                Helper::trackmessage($this->user, $opanesthesiology, 'patientassesment_createoredit', session()->getId(), 'WEB', 'Patient Assessment Created');
                ...
                $opanesthesiology = $this->user
                    ->opanesthesiologycreatable()
                ...
                $this->outpatient->specialable()->associate($opanesthesiology)
                    ->save();
                if ($this->is_movetoip) {
                    $inpatient = $this->user->inpatientcreatable()
                        ->create([
                ...
                Helper::trackmessage($this->user, $opanesthesiology, 'patient_createoredit', session()->getId(), 'WEB', 'Patient Assessment Created');
    ...
    protected function multiselectsync($opanesthesiology)
    {
        $opanesthesiology->currentcomplaints()->sync($this->currentcomplaint);
        $opanesthesiology->physicalexam()->sync($this->physicalexam);
        $opanesthesiology->diagnosismaster()->sync($this->diagnosismaster);

        $this->labinvestigationsync($this->labinvestigation, $this->user, $this->outpatient->patient_id, $opanesthesiology, 'OP', 'OP Anesthesiology', $this->is_labinvestigationemergency);
        $this->scaninvestigationsync($this->scaninvestigation, $this->user, $this->outpatient->patient_id, $opanesthesiology, 'OP', 'OP Anesthesiology', $this->is_scaninvestigationemergency);
        $this->xrayinvestigationsync($this->xrayinvestigation, $this->user, $this->outpatient->patient_id, $opanesthesiology, 'OP', 'OP Anesthesiology', $this->is_xrayinvestigationemergency);
    }
    ...
    {
        return view('livewire.admin.outpatient.opassessment.opassessmentanesthesiology.opassessmentanesthesiologylivewire');
    }
}
