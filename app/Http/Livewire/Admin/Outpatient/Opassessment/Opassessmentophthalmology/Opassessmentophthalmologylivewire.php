...
namespace App\Http\Livewire\Admin\Outpatient\Opassessment\Opassessmentophthalmology;
...
class Opassessmentophthalmologylivewire extends Component
{
    ...
    public function store()
    {
        ...
        if ($this->labinvestigation_file) {
            $validatedData['labinvestigation_file'] = $this->uploadfile($this->outpatient->specialable ? $this->outpatient->specialable->id : null, $this->labinvestigation_file, '/admin/outpatient/' . $this->outpatient->uniqid, 'App\Models\Admin\Outpatient\Ophthalmology\Opophthalmology', 'labinvestigation_file');
        ...
        if ($this->scaninvestigation_file) {
            $validatedData['scaninvestigation_file'] = $this->uploadfile($this->outpatient->specialable ? $this->outpatient->specialable->id : null, $this->scaninvestigation_file, '/admin/outpatient/' . $this->outpatient->uniqid, 'App\Models\Admin\Outpatient\Ophthalmology\Opophthalmology', 'scaninvestigation_file');
        ...
        if ($this->xrayinvestigation_file) {
            $validatedData['xrayinvestigation_file'] = $this->uploadfile($this->outpatient->specialable ? $this->outpatient->specialable->id : null, $this->xrayinvestigation_file, '/admin/outpatient/' . $this->outpatient->uniqid, 'App\Models\Admin\Outpatient\Ophthalmology\Opophthalmology', 'xrayinvestigation_file');
        ...
        if ($this->prescription_file) {
            $validatedData['prescription_file'] = $this->uploadfile($this->outpatient->specialable ? $this->outpatient->specialable->id : null, $this->prescription_file, '/admin/outpatient/' . $this->outpatient->uniqid, 'App\Models\Admin\Outpatient\Ophthalmology\Opophthalmology', 'prescription_file');
        ...
        try {
            ...
            if ($this->outpatient->specialable) {
                $opophthalmology = $this->outpatient->specialable;
                $opophthalmology->update($validatedData);
                $this->user->opophthalmologyupdatable()->save($opophthalmology);

                $this->multiselectsync($opophthalmology);
                ...
                Helper::trackmessage($this->user, $opophthalmology, 'patientassesment_createoredit', session()->getId(), 'WEB', 'Patient Assessment Created');
                ...
                $opophthalmology = $this->user
                    ->opophthalmologycreatable()
                ...
                $this->outpatient->specialable()->associate($opophthalmology)
                    ->save();
                if ($this->is_movetoip) {
                    $inpatient = $this->user->inpatientcreatable()
                        ->create([
                ...
                Helper::trackmessage($this->user, $opophthalmology, 'patient_createoredit', session()->getId(), 'WEB', 'Patient Assessment Created');
    ...
    protected function multiselectsync($opophthalmology)
    {
        $opophthalmology->currentcomplaints()->sync($this->currentcomplaint);
        $opophthalmology->physicalexam()->sync($this->physicalexam);
        $opophthalmology->diagnosismaster()->sync($this->diagnosismaster);

        $this->labinvestigationsync($this->labinvestigation, $this->user, $this->outpatient->patient_id, $opophthalmology, 'OP', 'OP Ophthalmology', $this->is_labinvestigationemergency);
        $this->scaninvestigationsync($this->scaninvestigation, $this->user, $this->outpatient->patient_id, $opophthalmology, 'OP', 'OP Ophthalmology', $this->is_scaninvestigationemergency);
        $this->xrayinvestigationsync($this->xrayinvestigation, $this->user, $this->outpatient->patient_id, $opophthalmology, 'OP', 'OP Ophthalmology', $this->is_xrayinvestigationemergency);
    }
    ...
    {
        return view('livewire.admin.outpatient.opassessment.opassessmentophthalmology.opassessmentophthalmologylivewire');
    }
}
