...
namespace App\Http\Livewire\Admin\Outpatient\Opassessment\Opassessmentdermatology;
...
class Opassessmentdermatologylivewire extends Component
{
    ...
    public function store()
    {
        ...
        if ($this->labinvestigation_file) {
            $validatedData['labinvestigation_file'] = $this->uploadfile($this->outpatient->specialable ? $this->outpatient->specialable->id : null, $this->labinvestigation_file, '/admin/outpatient/' . $this->outpatient->uniqid, 'App\Models\Admin\Outpatient\Dermatology\Opdermatology', 'labinvestigation_file');
        ...
        if ($this->scaninvestigation_file) {
            $validatedData['scaninvestigation_file'] = $this->uploadfile($this->outpatient->specialable ? $this->outpatient->specialable->id : null, $this->scaninvestigation_file, '/admin/outpatient/' . $this->outpatient->uniqid, 'App\Models\Admin\Outpatient\Dermatology\Opdermatology', 'scaninvestigation_file');
        ...
        if ($this->xrayinvestigation_file) {
            $validatedData['xrayinvestigation_file'] = $this->uploadfile($this->outpatient->specialable ? $this->outpatient->specialable->id : null, $this->xrayinvestigation_file, '/admin/outpatient/' . $this->outpatient->uniqid, 'App\Models\Admin\Outpatient\Dermatology\Opdermatology', 'xrayinvestigation_file');
        ...
        if ($this->prescription_file) {
            $validatedData['prescription_file'] = $this->uploadfile($this->outpatient->specialable ? $this->outpatient->specialable->id : null, $this->prescription_file, '/admin/outpatient/' . $this->outpatient->uniqid, 'App\Models\Admin\Outpatient\Dermatology\Opdermatology', 'prescription_file');
        ...
        try {
            ...
            if ($this->outpatient->specialable) {
                $opdermatology = $this->outpatient->specialable;
                $opdermatology->update($validatedData);
                $this->user->opdermatologyupdatable()->save($opdermatology);

                $this->multiselectsync($opdermatology);
                ...
                Helper::trackmessage($this->user, $opdermatology, 'patientassesment_createoredit', session()->getId(), 'WEB', 'Patient Assessment Created');
                ...
                $opdermatology = $this->user
                    ->opdermatologycreatable()
                ...
                $this->outpatient->specialable()->associate($opdermatology)
                    ->save();
                if ($this->is_movetoip) {
                    $inpatient = $this->user->inpatientcreatable()
                        ->create([
                ...
                Helper::trackmessage($this->user, $opdermatology, 'patient_createoredit', session()->getId(), 'WEB', 'Patient Assessment Created');
    ...
    protected function multiselectsync($opdermatology)
    {
        $opdermatology->currentcomplaints()->sync($this->currentcomplaint);
        $opdermatology->physicalexam()->sync($this->physicalexam);
        $opdermatology->diagnosismaster()->sync($this->diagnosismaster);

        $this->labinvestigationsync($this->labinvestigation, $this->user, $this->outpatient->patient_id, $opdermatology, 'OP', 'OP Dermatology', $this->is_labinvestigationemergency);
        $this->scaninvestigationsync($this->scaninvestigation, $this->user, $this->outpatient->patient_id, $opdermatology, 'OP', 'OP Dermatology', $this->is_scaninvestigationemergency);
        $this->xrayinvestigationsync($this->xrayinvestigation, $this->user, $this->outpatient->patient_id, $opdermatology, 'OP', 'OP Dermatology', $this->is_xrayinvestigationemergency);
    }
    ...
    {
        return view('livewire.admin.outpatient.opassessment.opassessmentdermatology.opassessmentdermatologylivewire');
    }
}
