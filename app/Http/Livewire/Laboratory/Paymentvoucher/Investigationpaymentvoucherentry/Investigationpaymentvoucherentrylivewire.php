...
namespace App\Http\Livewire\Laboratory\Paymentvoucher\Investigationpaymentvoucherentry;
...
class Investigationpaymentvoucherentrylivewire extends Component
{
    ...
    public $modeofpaymentdata = [], $payment_type_data = [];
    ...
    public function mount()
    {
        ...
        $this->payment_type_data = collect(config('archive.receipt_type'))->where('maintype', 'Investigation')->toArray();
    ...
    public function store()
    {
        ...
        try {
            ...
            return redirect()->route('investigationpaymentvoucherentry');
        } catch (Exception $e) {
            $this->exceptionerror($this->user, 'investigation_paymentvoucher_createoredit', 'error_one : ' . $e->getMessage());
        } catch (QueryException $e) {
            $this->exceptionerror($this->user, 'investigation_paymentvoucher_createoredit', 'error_two : ' . $e->getMessage());
        } catch (PDOException $e) {
            $this->exceptionerror($this->user, 'investigation_paymentvoucher_createoredit', 'error_three : ' . $e->getMessage());
        }
    }
    ...
    {
        return view('livewire.laboratory.paymentvoucher.investigationpaymentvoucherentry.investigationpaymentvoucherentrylivewire');
    }
}
