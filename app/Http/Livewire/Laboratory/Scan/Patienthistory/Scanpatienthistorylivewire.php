...
namespace App\Http\Livewire\Laboratory\Scan\Patienthistory;
...
class Scanpatienthistorylivewire extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.laboratory.scan.patienthistory.scanpatienthistorylivewire',
            compact('scanpatient'));
    }
}
