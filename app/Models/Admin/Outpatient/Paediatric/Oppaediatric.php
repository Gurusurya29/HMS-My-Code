...
namespace App\Models\Admin\Outpatient\Paediatric;
...
class Oppaediatric extends Model
{
    ...
    {
        return $this->belongsToMany(Labinvestigation::class, 'scaninvestigation_oppaediatric')->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany(Labinvestigation::class, 'xrayinvestigation_oppaediatric')->withTimestamps();
    }
