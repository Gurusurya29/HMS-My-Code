...
namespace App\Models\Admin\Outpatient\Urology;
...
class Opurology extends Model
{
    use AdminbootTraits, AdmingeneralTraits;

    public static $prefix = [6, 'U'];
    ...
    {
        return $this->belongsToMany(Labinvestigation::class, 'scaninvestigation_opurology')->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany(Labinvestigation::class, 'xrayinvestigation_opurology')->withTimestamps();
    }
