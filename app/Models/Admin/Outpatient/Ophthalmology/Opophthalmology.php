...
namespace App\Models\Admin\Outpatient\Ophthalmology;
...
class Opophthalmology extends Model
{
    use AdminbootTraits, AdmingeneralTraits;

    public static $prefix = [6, 'O'];
    ...
    {
        return $this->belongsToMany(Labinvestigation::class, 'scaninvestigation_opophthalmology')->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany(Labinvestigation::class, 'xrayinvestigation_opophthalmology')->withTimestamps();
    }
