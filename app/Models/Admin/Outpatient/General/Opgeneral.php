...
namespace App\Models\Admin\Outpatient\General;
...
class Opgeneral extends Model
{
    use AdminbootTraits, AdmingeneralTraits;

    public static $prefix = [6, 'G'];
    ...
    {
        return $this->belongsToMany(Labinvestigation::class, 'scaninvestigation_opgeneral')->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany(Labinvestigation::class, 'xrayinvestigation_opgeneral')->withTimestamps();
    }
