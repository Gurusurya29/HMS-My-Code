...
namespace App\Models\Admin\Outpatient\Generalsurgeon;
...
class Opgeneralsurgeon extends Model
{
    use AdminbootTraits, AdmingeneralTraits;

    public static $prefix = [6, 'GS'];
    ...
    {
        return $this->belongsToMany(Labinvestigation::class, 'scaninvestigation_opgeneralsurgeon')->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany(Labinvestigation::class, 'xrayinvestigation_opgeneralsurgeon')->withTimestamps();
    }
