...
namespace App\Models\Admin\Outpatient\Neurology;
...
class Opneurology extends Model
{
    ...
    {
        return $this->belongsToMany(Labinvestigation::class, 'scaninvestigation_opneurology')->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany(Labinvestigation::class, 'xrayinvestigation_opneurology')->withTimestamps();
    }
