...
namespace App\Models\Admin\Outpatient\Anesthesiology;
...
class Opanesthesiology extends Model
{
    ...
    {
        return $this->belongsToMany(Labinvestigation::class, 'scaninvestigation_opanesthesiology')->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany(Labinvestigation::class, 'xrayinvestigation_opanesthesiology')->withTimestamps();
    }
