...
namespace App\Models\Admin\Outpatient\Ortho;
...
class Oporthopedic extends Model
{
    use AdminbootTraits, AdmingeneralTraits;

    public static $prefix = [6, 'ORT'];
    ...
    {
        return $this->belongsToMany(Labinvestigation::class, 'scaninvestigation_oporthopedic')->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany(Labinvestigation::class, 'xrayinvestigation_oporthopedic')->withTimestamps();
    }
