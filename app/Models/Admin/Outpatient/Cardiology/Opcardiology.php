...
namespace App\Models\Admin\Outpatient\Cardiology;
...
class Opcardiology extends Model
{
    ...
    {
        return $this->belongsToMany(Labinvestigation::class, 'scaninvestigation_opcardiology')->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany(Labinvestigation::class, 'xrayinvestigation_opcardiology')->withTimestamps();
    }
