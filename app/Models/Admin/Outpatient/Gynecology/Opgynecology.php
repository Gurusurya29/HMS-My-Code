...
namespace App\Models\Admin\Outpatient\Gynecology;
...
class Opgynecology extends Model
{
    use AdminbootTraits, AdmingeneralTraits;

    public static $prefix = [6, 'GYN'];
    ...
    {
        return $this->belongsToMany(Labinvestigation::class, 'scaninvestigation_opgynecology')->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany(Labinvestigation::class, 'xrayinvestigation_opgynecology')->withTimestamps();
    }
