...
namespace App\Models\Admin\Outpatient\Nephrology;
...
class Opnephrology extends Model
{
    use AdminbootTraits, AdmingeneralTraits;

    public static $prefix = [6, 'N'];
    ...
    {
        return $this->belongsToMany(Labinvestigation::class, 'scaninvestigation_opnephrology')->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany(Labinvestigation::class, 'xrayinvestigation_opnephrology')->withTimestamps();
    }
