...
namespace App\Models\Admin\Outpatient\Diabetology;
...
class Opdiabetology extends Model
{
    ...
    {
        return $this->belongsToMany(Labinvestigation::class, 'scaninvestigation_opdiabetology')->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany(Labinvestigation::class, 'xrayinvestigation_opdiabetology')->withTimestamps();
    }
