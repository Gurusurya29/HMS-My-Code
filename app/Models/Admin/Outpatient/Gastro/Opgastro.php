...
namespace App\Models\Admin\Outpatient\Gastro;
...
class Opgastro extends Model
{
    ...
    {
        return $this->belongsToMany(Labinvestigation::class, 'scaninvestigation_opgastro')->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany(Labinvestigation::class, 'xrayinvestigation_opgastro')->withTimestamps();
    }
