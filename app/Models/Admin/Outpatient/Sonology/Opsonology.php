...
namespace App\Models\Admin\Outpatient\Sonology;
...
class Opsonology extends Model
{
    ...
    {
        return $this->belongsToMany(Labinvestigation::class, 'scaninvestigation_opsonology')->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany(Labinvestigation::class, 'xrayinvestigation_opsonology')->withTimestamps();
    }
