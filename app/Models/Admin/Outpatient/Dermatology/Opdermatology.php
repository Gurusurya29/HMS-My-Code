...
namespace App\Models\Admin\Outpatient\Dermatology;
...
class Opdermatology extends Model
{
    ...
    {
        return $this->belongsToMany(Labinvestigation::class, 'scaninvestigation_opdermatology')->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany(Labinvestigation::class, 'xrayinvestigation_opdermatology')->withTimestamps();
    }
