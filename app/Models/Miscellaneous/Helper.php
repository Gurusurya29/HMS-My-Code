...
class Helper extends Model
{
    ...
    // public static function trackmessage($user, $functionable, $function,  $sessionid = null , $type, $trackmsg)
    // {
    //     $user->trackable()
    //         ->make([
    //             'name' => $user->name,
    ...
    public static function trackmessage($user, $functionable, $function, $type, $trackmsg, $sessionid = null)
    {
        $user->trackable()
            ->make([
                'name'      => $user->name,
