...
@section('main-content')
    <x-pharmacy.layouts.pharmacybreadcrumb>
        ...
        <li class="breadcrumb-item active" aria-current="page">Manufacture Name</li>
    </x-pharmacy.layouts.pharmacybreadcrumb>

    @livewire('pharmacy.settings.drugmaster.pharmacymanufacture.pharmacymanufacturelivewire')
@endsection
