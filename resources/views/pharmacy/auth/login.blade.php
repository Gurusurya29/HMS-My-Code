                ...
                <form method="POST" action="{{ route('pharmacyloginpost') }}"
                    ...
                    <div class="form-floating mb-3">
                        <input name="username" type="text"
                            ...
                            {{ env('APP_ENV') == 'local' ? 'value = pharmacy' : ('value =' . old('username') ? old('username') : '') }}
                            required autofocus>
