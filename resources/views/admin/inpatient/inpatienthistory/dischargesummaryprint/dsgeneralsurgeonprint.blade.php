    ...
    <div id="printdiv" style="position: relative;">
        ...
        <div class="patient_details" style="font-weight: bold; font-size:16px;">
            ...
            <div class="patientdetails_container">
                ...
                <div> D.O.A </div>
                <div style="font-weight: normal;">
                    : {{ Carbon\Carbon::parse($inpatient->ipadmission->admission_date)->format('d-m-Y h:i A') }}
                </div>
                <div> D.O.S </div>
                <div style="font-weight: normal;">
                    :
        ...
        @endif
        @if ($inpatient->dsspecialable->treatment)
            <div style="text-align: left; font-weight: bold;font-size:16px; margin-top:3%">TREATMENT:</div>
            <p style="margin-left: 7%">{!! $inpatient->dsspecialable->treatment !!}</p>
        @endif
        ...
        @if ($inpatient->dsspecialable->followupvisit)
            ...
            @endif
        @endif
        <div style="position: absolute ; bottom: 30; right: 70px;font-size:20px;">
            Doctor signature
        </div>
    </div>
    <script>
