...
@section('main-content')
    <x-admin.layouts.adminbreadcrumb>
        ...
        <li class="breadcrumb-item active" aria-current="page">Doctor Specialization</li>
    </x-admin.layouts.adminbreadcrumb>
    @can('Doctor-specialization')
        @livewire('admin.settings.doctorsetting.doctorspecialization.doctorspecializationlivewire')
    @endcan
@endsection
