...
@section('main-content')
    <x-admin.layouts.adminbreadcrumb>
        ...
        <li class="breadcrumb-item active" aria-current="page">Current Complaints</li>
    </x-admin.layouts.adminbreadcrumb>

    @can('Current-complaints')
        @livewire('admin.settings.patientvisitsetting.currentcomplaints.currentcomplaintslivewire')
    @endcan
@endsection
