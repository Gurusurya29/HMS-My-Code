...
<div class="card col-sm-12 mx-auto border-0">
    <div class="card-body bg-light p-0">
        ...
        @livewire('admin.patientregistration.patientvisithistory.patientvisithistorylivewire')
        @endcan
    </div>
</div>
@endsection
...
<script>
    Livewire.on('printtoken', patientvisitid => {
        var url = "{{ url('/') }}" + "/admin/printtoken/" + patientvisitid;
        window.open(url);
    });
</script>
