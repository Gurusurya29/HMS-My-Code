...
<body>
    ...
    <div id="printdiv" style="overflow-x:auto;">
        <div>
            ...
            <div style="text-align: center; font-weight: bold;font-size:18px;margin-top:5px;">IP DETAILED BILL</div>
            <div>
                        ...
                        <tbody class="text_align">
                            ...
                            border:1px solid black">
                                ...
                                <td style="
                                    ...
                                    @foreach ($eachbill_list as $item)
                                    <div style="margin: 4px 0">{{ $item->ipservice_fee }}</div>
                                    @endforeach
                                ...
                                <td style="
                                            border:1px solid black; text-align:right;">
                                    @foreach ($eachbill_list as $item)
                                    <div style="margin: 4px 0">{{ $item->quantity }}</div>
                                    @endforeach
                                ...
                                <td style="
                                                    border:1px solid black; text-align:right;">
                                    @foreach ($eachbill_list as $item)
                                    <div style="margin: 4px 0">{{ $item->final_amount }}</div>
                                    @endforeach
                            ...
                            <tr>
                                <td colspan="5" style="text-align: right; border:1px solid black;font-weight:bold;">
                                    Discount</td>
