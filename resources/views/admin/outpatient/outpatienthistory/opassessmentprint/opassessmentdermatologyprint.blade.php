...
<body>
    ...
    <div id="printdiv">
        ...
        <table style="width:100%; margin-top:1%;margin-bottom:3%;" class="data">
            <tbody>
                <tr>
                    <td class="row label">VISIT ID</td>
                    <td class="row ">:
                        {{ $outpatient->patientvisit->uniqid }}</td>
                </tr>
                <tr>
                    <td class="row label">TOKEN </td>
                    <td class="row ">:
                        {{ $outpatient->patientvisit->id }}</td>
                </tr>
                <tr>
                    <td class="row label">SPECIALTY </td>
                    <td class="row ">:
                        {{ $outpatient->patientvisit->doctorspecialization->name }}</td>
                </tr>
                <tr>
                    <td class="row label">VISIT CATEGORY </td>
                    <td class="row ">:
                        {{ $outpatient->patientvisit->visit_category_id ? config('archive.visit_category')[$outpatient->patientvisit->visit_category_id] : '' }}
                    </td>
                </tr>
                <tr>
        ...
        <table style="width:100%; margin-top:3%;margin-bottom:3%;" class="data">
            <tbody>
                <tr>
                    ...
                    <td class="row "> : {{ $outpatient->specialable->pasthistory_note }}</td>
                </tr>
                <tr>
                    <td class="row label">NUTRITIONAL SCREENING</td>
                    <td class="row "> : {{ $outpatient->specialable->nutritionalscreening_note }}</td>
                </tr>
                <tr>
                    <td class="row label">PLAN OF CARE :</td>
                    <td class="row "> : {{ $outpatient->specialable->planofcare_note }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="row "> : {{ $outpatient->specialable->nextvisit_date }}
                    </td>
                </tr>
                <tr>
