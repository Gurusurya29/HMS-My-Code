...
@section('main-content')
    <x-admin.layouts.adminbreadcrumb>
        ...
        <li class="breadcrumb-item active" aria-current="page">Patient Ledger Report</li>
    </x-admin.layouts.adminbreadcrumb>
    @can('Patient Ledger-report')
        @livewire('admin.reports.accountreports.patientstatementreport.patientstatementreportlivewire')
    @endcan
@endsection
