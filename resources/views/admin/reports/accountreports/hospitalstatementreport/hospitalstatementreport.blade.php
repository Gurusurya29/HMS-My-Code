...
@section('main-content')
    <x-admin.layouts.adminbreadcrumb>
        ...
        <li class="breadcrumb-item active" aria-current="page">Hospital Ledger Report</li>
    </x-admin.layouts.adminbreadcrumb>
    @can('Hospital Ledger-report')
        @livewire('admin.reports.accountreports.hospitalstatementreport.hospitalstatementreportlivewire')
    @endcan
@endsection
