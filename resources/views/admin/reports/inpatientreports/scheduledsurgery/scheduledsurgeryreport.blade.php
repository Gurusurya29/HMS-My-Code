...
@section('main-content')
    <x-admin.layouts.adminbreadcrumb>
        ...
        <li class="breadcrumb-item active" aria-current="page">Scheduled Surgery Report</li>
    </x-admin.layouts.adminbreadcrumb>
    @can('Scheduled Surgery-report')
        @livewire('admin.reports.inpatientreports.scheduledsurgery.scheduledsurgeryreportlivewire')
    @endcan
@endsection
