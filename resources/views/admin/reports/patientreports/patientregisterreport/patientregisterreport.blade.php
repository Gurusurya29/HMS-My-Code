...
@section('main-content')
    <x-admin.layouts.adminbreadcrumb>
        ...
        <li class="breadcrumb-item active" aria-current="page">New Patient Register Report</li>
    </x-admin.layouts.adminbreadcrumb>
    @can('Patientregistration-report')
        @livewire('admin.reports.patientreports.patientregisterreport.patientregisterreportlivewire')
    @endcan
@endsection
