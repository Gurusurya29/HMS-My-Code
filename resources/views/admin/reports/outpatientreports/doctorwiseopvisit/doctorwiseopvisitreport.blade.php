...
@section('main-content')
    <x-admin.layouts.adminbreadcrumb>
        ...
        <li class="breadcrumb-item active" aria-current="page">Doctor Wise OP Visit Report</li>
    </x-admin.layouts.adminbreadcrumb>
    @can('Doctor Wise OP Visit-report')
        @livewire('admin.reports.outpatientreports.doctorwiseopvisit.doctorwiseopvisitreportlivewire')
    @endcan
@endsection
