...
@section('main-content')
    <x-admin.layouts.adminbreadcrumb>
        ...
        <li class="breadcrumb-item active" aria-current="page">Out Patient Report</li>
    </x-admin.layouts.adminbreadcrumb>

    @livewire('admin.reports.outpatientreports.outpatientreport.outpatientreportlivewire')
@endsection
