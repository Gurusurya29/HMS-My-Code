...
@section('main-content')
    <x-admin.layouts.adminbreadcrumb>
        ...
        <li class="breadcrumb-item active" aria-current="page">Doctor Wise OP Bill Report</li>
    </x-admin.layouts.adminbreadcrumb>
    @can('Doctor Wise OP Bill-report')
        @livewire('admin.reports.outpatientreports.doctorwiseopbill.doctorwiseopbillreportlivewire')
    @endcan
@endsection
