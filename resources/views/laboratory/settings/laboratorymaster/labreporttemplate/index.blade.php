...
@section('main-content')
    <x-laboratory.layouts.laboratorybreadcrumb>
        ...
        <li class="breadcrumb-item active" aria-current="page">Report Template</li>
    </x-laboratory.layouts.laboratorybreadcrumb>

    @livewire('laboratory.settings.laboratorymaster.labreporttemplate.labreporttemplatelivewire')
@endsection
