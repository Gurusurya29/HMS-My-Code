...
<body>
    @if ($scanpatient->scanpatientlist->whereNotNull('is_movedtobill')->groupBy('labinvestigationgroup_name')->isNotEmpty())
        ...
        <div id="printdiv" style="overflow-x:auto;">
            <div>
                ...
                <div style="text-align: center; font-weight: bold;font-size:18px;margin-top:5px;">SCAN DETAILED
                    BILL</div>
                <div>
                    ...
                    <div style="margin-top:15px; font-size:14px;">
                        <table
                            ...
                            <tbody class="text_align">
                                @foreach ($scanpatient->scanpatientlist->whereNotNull('is_movedtobill')->groupBy('labinvestigationgroup_name') as $key => $eachscanpatientlist)
                                    <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="border:1px solid black;">
                                        <div>
                                            {{ $scanpatient->scanpatientlist->where('is_movedtobill', true)->sum('fee') }}
                                        </div>
                                        <div>
                                            {{ $scanpatient->discount_value }}({{ $scanpatient->discount_percentage }}%)
                                        </div>
                                        <div>{{ $scanpatient->grand_total }}</div>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
