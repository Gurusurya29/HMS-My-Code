...
<body>
    ...
    <div id="printdiv">
        ...
        <div style="text-align: center; font-weight: bold;font-size:20px;">PAYMENT RECEIPT</div>
        <div style="border: 2px solid rgb(58, 57, 57); border-radius: 10px; margin-top:5px;">
            <div class="patient_details" style="font-weight: bold; font-size:16px;">
                <div>
                    <p> Receipt No : <span style="font-weight: normal">
                            @if ($receipt->lab_uniqid)
                            {{ $receipt->lab_uniqid }}
                            @elseif($receipt->scan_uniqid)
                            {{ $receipt->scan_uniqid }}
                            @elseif($receipt->xray_uniqid)
                            {{ $receipt->xray_uniqid }}
                            @endif
                        </span></p>
        ...
        <div
            style="font-size:16px; padding:5px; border: 2px solid rgb(58, 57, 57); border-radius: 10px; margin-top:5px;">
