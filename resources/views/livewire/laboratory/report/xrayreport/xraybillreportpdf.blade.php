        ...
        <tfoot>
            <tr>
                ...
                <td style="border: 1px solid; padding:5px;">
                    {{ $xraypatient->sum('total') }}</td>
                <td style="border: 1px solid; padding:5px;">
                    {{ $xraypatient->sum('discount_value') }} ({{ $xraypatient->sum('discount_percentage') }})</td>
                <td style="border: 1px solid; padding:5px;">
                    {{ $xraypatient->sum('grand_total') }}</td>
            </tr>
        </tfoot>
    </table>
</div>
