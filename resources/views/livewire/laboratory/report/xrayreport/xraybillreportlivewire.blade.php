    ...
    <div class="card shadow-sm">
        <div class="card-header text-white theme_bg_color p-1">
            <div class="d-flex flex-row bd-highlight">
                <div class="flex-grow-1 bd-highlight mt-1"><span class="h5">XRAY BILL REPORT</span></div>
        ...
        <div class="card-body p-0">
            ...
            <div class="d-flex justify-content-end">
                <h4 class="fw-bold mx-4 my-3 text-end">Total Bill Amount: <span class="text-primary">Rs.
                        {{ $grand_total }}</span></h5>
            </div>
            <div class="table-responsive">
                <table id="xraypatientreport_id" class="table text-center table-hover m-0 p-0">
                    ...
                    <tbody>
                        @foreach ($xraypatient as $key => $item)
                            <tr>
                                <td>{{ $xraypatient->firstItem() + $key }}</td>
                                <td>{{ $item->uniqid }}</td>
                                ...
                                <td>{{ $item->total }}</td>
                                <td>{{ $item->discount_value }}({{ $item->discount_percentage }}%)</td>
