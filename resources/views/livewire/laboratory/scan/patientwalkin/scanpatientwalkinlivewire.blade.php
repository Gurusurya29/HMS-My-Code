                                ...
                                <div class="dropdown">
                                    ...
                                    @if (!empty($searchquery))
                                        <ul class="dropdown-menu list-group w-100 border-0 m-0 p-0">
                                            @if (!empty($scaninvestigation))
                                                @foreach ($scaninvestigation as $i => $eachscaninvestigation)
                                                    <li wire:click="additem({{ $eachscaninvestigation['id'] }})"
                                                        class="list-group-item list-group-item-action d-flex justify-content-between align-items-center"
                                                        role="button">
                                                        <h6> {{ $eachscaninvestigation['name'] }} </h6>
                                                    </li>
                                                @endforeach
                                            @else
                                                <li
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped p-0 m-0">
                                        ...
                                        <tbody>
                                            @if ($selectedscaninvestigation)
                                                @foreach ($selectedscaninvestigation as $key => $eachscaninvestigation)
                                                    <tr>
                                                        <td>
                                                            {{ $key + 1 }}
                                                        </td>
                                                        <td>
                                                            {{ $eachscaninvestigation['labinvestigation_name'] }}
                                                        </td>
                                                        <td>
                                                            {{ $eachscaninvestigation['selffee'] }}
                                                        </td>
                                ...
                                @if (!empty($selectedscaninvestigation))
