<div wire:ignore.self class="modal fade" id="createoreditModal" data-bs-backdrop="static" data-bs-keylabtestmethod="false"
            ...
            <form wire:submit.prevent="store" enctype="multipart/form-data" autocomplete="off">
                <div class="modal-header text-white theme_bg_color px-3 py-2">
                    <h5 class="modal-title" id="createoreditModalLabel">
                        {{ isset($labtestmethod_id) ? 'UPDATE' : 'CREATE' }}
                        TEST METHOD </h5>
                ...
                <div class="modal-footer bg-light px-2 py-1">
                    ...
                    <button wire:loading.remove type="submit" wire:target="store"
                        class="btn btn-primary">{{ isset($labtestmethod_id) ? 'Update' : 'Save' }}</button>
                </div>
            </form>
        </div>
    </div>
