<div class="mt-4">
            ...
            @foreach ($paymentvoucherhistory as $index => $eachpaymentvoucherhistory)
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <button wire:click="investigationvoucherprint({{ $eachpaymentvoucherhistory->id }})"
    ...
    @include('livewire.laboratory.paymentvoucher.investigationpaymentvoucherhistory.show')
</div>
