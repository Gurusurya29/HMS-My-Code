    ...
    <div class="card shadow-sm">
        <div class="card-header text-white theme_bg_color p-1">
            <div class="d-flex flex-row bd-highlight">
                <div class="flex-grow-1 bd-highlight mt-1"><span class="h5">SALES ENTRY ITEMS</span>
                </div>
        ...
        <div class="card-body p-0">
            ...
            <div class="table-responsive">
                <table id="labpatientreport_id" class="table text-center table-hover m-0 p-0">
                    ...
                    <tbody>
                        @foreach ($saleentry as $key => $item)
                            <tr>
                                <td>{{ $saleentry->firstItem() + $key }}</td>
                                <td>{{ $item->pharmproduct->name }}</td>
                                <td>{{ $item->pharmsalesentry->patient->phone }}</td>
                                <td>{{ $item->batch }}</td>
                                ...
                                <td>{{ $item->pharmsalesentry->creatable->name }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
