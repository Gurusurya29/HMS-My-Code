        ...
        @if ($showdata)
            <div class="modal-content">
                <div class="modal-header text-white theme_bg_color px-3 py-2">
                    <h5 class="modal-title" id="showModalLabel">EXPENSE ENTRY : {{ $showdata->uniqid }} </h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        @include('helper.formhelper.showlabel', [
                            ...
                            'value' => config('pharmacyarchive.expense_type')[$showdata->expense_type],
                            'columnone' => 'col-md-6',
                            'columntwo' => 'col-5',
                            'columnthree' => 'col-7',
                        ])
                        ...
                        @include('helper.formhelper.showlabel', [
                            'name' => 'PAYMENT MODE',
                            'value' => config('pharmacyarchive.payment_mode')[$showdata->payment_mode],
                            'columnone' => 'col-md-6',
                            'columntwo' => 'col-5',
                            'columnthree' => 'col-7',
                        ])
                        @include('helper.formhelper.showlabel', [
                            'name' => 'REFERANCE NOTE',
                            'value' => $showdata->referance_notes,
                            'columnone' => 'col-md-6',
                            'columntwo' => 'col-5',
                            'columnthree' => 'col-7',
                        ])
