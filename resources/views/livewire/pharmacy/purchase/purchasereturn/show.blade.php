        ...
        @if ($showdata)
            <div class="modal-content">
                <div class="modal-header text-white theme_bg_color px-3 py-2">
                    <h5 class="modal-title" id="showModalLabel">PURCHASE RETURN ID : {{ $showdata->uniqid }} </h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        @include('helper.formhelper.showlabel', [
                            'name' => 'COMPANY NAME',
                            'value' => $showdata->supplier->company_name,
                            'columnone' => 'col-md-6',
                            'columntwo' => 'col-5',
                            'columnthree' => 'col-7',
                        ])
                        @include('helper.formhelper.showlabel', [
                            'name' => 'CONTACT PERSON',
                            'value' => $showdata->supplier->company_person_name,
                            'columnone' => 'col-md-6',
                            'columntwo' => 'col-5',
                            'columnthree' => 'col-7',
                        ])
                        @include('helper.formhelper.showlabel', [
                            'name' => 'MOBILE NUMBER',
                            'value' => $showdata->supplier->contact_mobile_no,
                            'columnone' => 'col-md-6',
                            'columntwo' => 'col-5',
                            'columnthree' => 'col-7',
                        ])
                        ...
                        @include('helper.formhelper.showlabel', [
                            ...
                            'value' => $showdata->negotiated_price,
                            'columnone' => 'col-md-6',
                            'columntwo' => 'col-5',
                            'columnthree' => 'col-7',
                        ])
                    ...
                    <table class="table table-bordered text-center text-primary table-light my-2">
                        ...
                        <tbody class="fs-5 text-primary">
                            @foreach ($showdata->purchasereturnitem as $value)
                                <tr class="text-black">
                                    <td class="fw-bold">
