<div class="mt-4">
        ...
        <x-slot name="tablebody">
            @foreach ($receipthistory as $index => $eachreceipthistory)
                <tr>
                    ...
                    <td class="text-center">
                        {{ config('archive.modeofpayment')[$eachreceipthistory->modeofpayment] }}
                    </td>
                    <td class="text-center">{{ $eachreceipthistory->created_at }}</td>
                    <td class="text-center">{{ $eachreceipthistory->creatable->name }}</td>
                    <td class="text-center">
    ...
    @include('livewire.pharmacy.receipt.show')
</div>
