        ...
        @if ($showdata)
            <div class="modal-content">
                <div class="modal-header text-white theme_bg_color px-3 py-2">
                    <h5 class="modal-title" id="showModalLabel"> SHOW USER : {{ $showdata->uniqid }} </h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        @if ($showdata->avatar)
                            <div class="row col-md-6 p-1">
                                ...
                                <label class="fst-normal text-break  col-7"><b> : </b>
                                    ...
                                    <img width="60" height="60" src="{{ Storage::url($showdata->avatar) }}"
                                        alt="Avatar">
                        ...
                        @include('helper.formhelper.showlabel', [
                            'name' => 'ACTIVE STATUS',
                            'value' => $showdata->is_accountactive
