            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row g-2">
                        ...
                        <div class="col-md-12">
                            <select wire:model.defer="currentcomplaint" id="currentcomplaint"
...
<!-- <script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function initSelect2(el, property) {
            const $el = $(el);
            if (!$el.length) return;
        ...
        function initAllSelects(root = document) {
            ...
            mappings.forEach(mapping => {
                $(root).find(mapping.class).each(function() {
                    initSelect2(this, mapping.property);
                });
            });
        }
