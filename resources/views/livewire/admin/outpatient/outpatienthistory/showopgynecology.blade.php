<div class="row text-dark shadow-sm rounded">
    ...
    <div class="card-title fw-bold fs-5"><u> General Examination</u></div>
    <div class="col-md-12 row justify-content-center">
        @include('helper.formhelper.showlabel', [
            'name' => 'PALLOR',
            'value' => $showdata->specialable->is_pallor ? 'YES' : 'NO',
            'columnone' => 'col-md-4',
            'columntwo' => 'col-6',
            'columnthree' => 'col-6',
        ])
        @include('helper.formhelper.showlabel', [
            'name' => 'CYANOSIS',
            'value' => $showdata->specialable->is_cyanosis ? 'YES' : 'NO',
            'columnone' => 'col-md-4',
            'columntwo' => 'col-6',
            'columnthree' => 'col-6',
        ])
        @include('helper.formhelper.showlabel', [
            'name' => 'ICTERUS',
            'value' => $showdata->specialable->is_icterus ? 'YES' : 'NO',
            'columnone' => 'col-md-4',
            'columntwo' => 'col-6',
            'columnthree' => 'col-6',
        ])
        @include('helper.formhelper.showlabel', [
            'name' => 'CLUBBING',
            'value' => $showdata->specialable->is_clubbing ? 'YES' : 'NO',
            'columnone' => 'col-md-4',
            'columntwo' => 'col-6',
            'columnthree' => 'col-6',
        ])
        @include('helper.formhelper.showlabel', [
            'name' => 'PEDALEDEMA',
            'value' => $showdata->specialable->is_pedaledema ? 'YES' : 'NO',
            'columnone' => 'col-md-4',
            'columntwo' => 'col-6',
            'columnthree' => 'col-6',
        ])
        @include('helper.formhelper.showlabel', [
            'name' => 'ANASARCA',
            'value' => $showdata->specialable->is_anasarca ? 'YES' : 'NO',
            'columnone' => 'col-md-4',
            'columntwo' => 'col-6',
            'columnthree' => 'col-6',
        ])
    ...
    <hr>
    <div class="card-title fw-bold fs-5"><u> Functional Assesment</u></div>
    @include('helper.formhelper.showlabel', [
        'name' => 'ABILITY TO PERFORM ROUTINE ACTIVITIES',
        'value' => ($showdata->specialable->functional_assesment === 1
                ? 'YES'
                : $showdata->specialable->functional_assesment === 0)
            ? 'NO'
            : '-',
        'columnone' => 'col-md-12',
        'columntwo' => 'col-5',
    ...
    @include('helper.formhelper.showlabel', [
        ...
        'value' => $showdata->specialable->abdominalexamination_note,
        'columnone' => 'col-md-6',
        'columntwo' => 'col-4',
        'columnthree' => 'col-8',
    ])
    @include('helper.formhelper.showlabel', [
        ...
        'value' => $showdata->specialable->nervoussystemexamination_note,
        'columnone' => 'col-md-6',
        'columntwo' => 'col-4',
        'columnthree' => 'col-8',
    ])
    @include('helper.formhelper.showlabel', [
        'name' => 'PER RECTAL EXAMINATION',
        'value' => $showdata->specialable->perrectalexamination_note,
        'columnone' => 'col-md-6',
        'columntwo' => 'col-4',
        'columnthree' => 'col-8',
    ])
    @include('helper.formhelper.showlabel', [
        'name' => 'PER VAGINAL EXAMINATION',
        'value' => $showdata->specialable->pervaginalexamination_note,
        'columnone' => 'col-md-6',
        'columntwo' => 'col-4',
        'columnthree' => 'col-8',
    ])
