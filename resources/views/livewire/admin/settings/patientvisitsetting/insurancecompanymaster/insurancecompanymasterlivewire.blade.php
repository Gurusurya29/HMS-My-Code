<div>
    ...
    @include('livewire.admin.settings.patientvisitsetting.insurancecompanymaster.createoredit')

    <!-- Show Modal -->
    @include('livewire.admin.settings.patientvisitsetting.insurancecompanymaster.show')
