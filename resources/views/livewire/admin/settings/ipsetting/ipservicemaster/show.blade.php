        ...
        @if ($showdata)
            <div class="modal-content">
                <div class="modal-header text-white theme_bg_color px-3 py-2">
                    <h5 class="modal-title" id="showModalLabel">IP BILLING SERVICE : {{ $showdata->uniqid }} </h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        @include('helper.formhelper.showlabel', [
                            ...
                            'value' => $showdata->ipservicecategory->name,
                            'columnone' => 'col-md-6',
                            'columntwo' => 'col-5',
                            'columnthree' => 'col-7',
                        ])
                        ...
                        @include('helper.formhelper.showlabel', [
                            'name' => 'PACKAGE',
                            'value' => $showdata->is_package ? 'YES' : 'NO',
                            'columnone' => 'col-md-6',
                            'columntwo' => 'col-5',
                            'columnthree' => 'col-7',
                        ])
                        @include('helper.formhelper.showlabel', [
                            'name' => 'IS OT SERVICE',
                            'value' => $showdata->is_otservice ? 'YES' : 'NO',
                            'columnone' => 'col-md-6',
                            'columntwo' => 'col-5',
                            'columnthree' => 'col-7',
                        ])
