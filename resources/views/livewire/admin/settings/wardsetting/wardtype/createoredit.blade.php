<div wire:ignore.self class="modal fade" id="createoreditModal" data-bs-backdrop="static" data-bs-keywardtype="false"
            ...
            <form wire:submit.prevent="store" enctype="multipart/form-data" autocomplete="off">
                <div class="modal-header text-white theme_bg_color px-3 py-2">
                    <h5 class="modal-title" id="createoreditModalLabel">
                        {{ isset($wardtype_id) ? 'UPDATE' : 'CREATE' }}
                        WARD TYPE </h5>
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        @include('helper.formhelper.form', [
                            'type' => 'select',
                            'fieldname' => 'ward_category',
                            'labelname' => 'WARD CATEGORY',
                            'labelidname' => 'ward_categoryid',
                            'default_option' => 'Select Category',
                            'option' => config('archive.ward_category'),
                            'required' => true,
                            'col' => 'col-md-4',
                        ])
                        @include('helper.formhelper.form', [
