        ...
        @if ($showdata)
            <div class="modal-content">
                <div class="modal-header text-white theme_bg_color px-3 py-2">
                    <h5 class="modal-title" id="showModalLabel">ADD DOCTOR : {{ $showdata->uniqid }}
                    </h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        @include('helper.formhelper.showlabel', [
                            'name' => 'PREVIOUS ROOM',
                            'value' => $showdata->previousroom_name,
                            'columnone' => 'col-md-6',
                            'columntwo' => 'col-5',
                            'columnthree' => 'col-7',
                        ])
                        @include('helper.formhelper.showlabel', [
                            'name' => 'CHANGED WARD',
                            'value' => $showdata->changedwardtype->name,
                            'columnone' => 'col-md-6',
                            'columntwo' => 'col-5',
                            'columnthree' => 'col-7',
                        ])
                        @include('helper.formhelper.showlabel', [
                            'name' => 'CHANGED BED/ROOM NO',
                            'value' => $showdata->changedroom_name,
                            'columnone' => 'col-md-6',
                            'columntwo' => 'col-5',
                            'columnthree' => 'col-7',
                        ])
