        ...
        @if ($showdata)
            <div class="modal-content">
                <div class="modal-header text-white theme_bg_color px-3 py-2">
                    <h5 class="modal-title" id="showModalLabel"> SHOW EMPLOYEE : {{ $showdata->uniqid }} </h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        @include('helper.formhelper.showlabel', [
                            ...
                            'value' => $showdata->doj ? date('d-m-Y', strtotime($showdata->doj)) : '',
                            'columnone' => 'col-md-6',
                            'columntwo' => 'col-5',
                            'columnthree' => 'col-7',
                        ])
                        @include('helper.formhelper.showlabel', [
                            ...
                            'value' => $showdata->education_qualification,
                            'columnone' => 'col-md-6',
                            'columntwo' => 'col-5',
                            'columnthree' => 'col-7',
                        ])
                        ...
                        @include('helper.formhelper.showlabel', [
                            'name' => 'PREVIOUS ORGANISATION',
                            'value' => $showdata->previous_organisation,
                            'columnone' => 'col-md-6',
                            'columntwo' => 'col-5',
                            'columnthree' => 'col-7',
                        ])
                        ...
                        @include('helper.formhelper.showlabel', [
                            ...
                            'value' => $showdata->bank_account_no,
                            'columnone' => 'col-md-6',
                            'columntwo' => 'col-5',
                            'columnthree' => 'col-7',
                        ])
