        ...
        <div class="card-body p-0 m-0">
            ...
            <div class="card m-4">
                <div class="card-header text-white theme_bg_color d-flex justify-content-between">
                    ...
                    <div>
                        @can('Ipbill')
                            <a href="{{ route('ipbillingservice', $ipbillingdata->uuid) }}"
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped p-0 m-0">
                            ...
                            <tbody>
                                @if ($ipreceiptdata)
                                    @if ($ipreceiptdata->isNotEmpty())
                                        @foreach ($ipreceiptdata as $key => $eachreceiptdata)
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                ...
                                                <td>
                                                    <button wire:click="printipreceiptlist({{ $eachreceiptdata->id }})"
