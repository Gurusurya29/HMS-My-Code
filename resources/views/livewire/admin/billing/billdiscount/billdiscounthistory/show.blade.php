        ...
        @if ($showdata)
            <div class="modal-content">
                <div class="modal-header text-white theme_bg_color px-3 py-2">
                    <h5 class="modal-title" id="showModalLabel">BILL DISOCUNT/CANCEL DETAILS</h5> :
                    {{ $showdata->uniqid }} </h5>
                ...
                <div class="modal-body">
                    <div class="row text-dark p-2 shadow-sm border border-2 border-secondary rounded">
                        ...
                        @include('helper.formhelper.showlabel', [
                            'name' => 'DISOCUNT/CANCEL',
                            'value' => config('archive.discount_type')[$showdata->discount_type],
                            'columnone' => 'col-md-6',
                            'columntwo' => 'col-5',
                            'columnthree' => 'col-7',
                        ])
                        @include('helper.formhelper.showlabel', [
                            'name' => 'BILL TYPE',
                            'value' => $showdata->bill_type
                                ? collect(config('archive.bill_type'))->where('id', $showdata->bill_type)->first()['subtype']
                                : '-',
                            'columnone' => 'col-md-6',
                            'columntwo' => 'col-5',
                            'columnthree' => 'col-7',
                        ...
                        @include('helper.formhelper.showlabel', [
                            'name' => 'AMOUNT',
                            'value' => $showdata->discount_amount,
                            'columnone' => 'col-md-6',
                            'columntwo' => 'col-5',
                            'columnthree' => 'col-7',
                        ])
