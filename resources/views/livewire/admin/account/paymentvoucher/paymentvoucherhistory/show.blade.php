            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row text-dark p-2 shadow-sm border border-2 border-secondary rounded">
                        ...
                        @if ($showdata->payment_to == 3)
                            @include('helper.formhelper.showlabel', [
                                'name' => 'PAYMENT TYPE',
                                'value' => $showdata->payment_type
                                    ? collect(config('archive.receipt_type_supplier'))->where('id', $showdata->payment_type)->first()['subtype']
                                    : '-',
                                'columnone' => 'col-md-6',
                                'columntwo' => 'col-5',
                                'columnthree' => 'col-7',
                        ...
                        @else
                            @include('helper.formhelper.showlabel', [
                                'name' => 'PAYMENT TYPE',
                                'value' => $showdata->payment_type
                                    ? collect(config('archive.receipt_type'))->where('id', $showdata->payment_type)->first()['subtype']
                                    : '-',
                                'columnone' => 'col-md-6',
                                'columntwo' => 'col-5',
                                'columnthree' => 'col-7',
