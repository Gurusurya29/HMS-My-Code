    ...
    <div class="card shadow-sm">
        <div class="card-header text-white theme_bg_color p-1">
            <div class="d-flex flex-row bd-highlight">
                <div class="flex-grow-1 bd-highlight mt-1"><span class="h5">PATIENT LEDGER REPORT</span>
                </div>
        ...
        <div class="card-body p-0 row justify-content-center">
            <div class="my-3 col-md-8">
                <div class="dropdown">
                    <label class="form-label fs-6" for="searchquery">Search Patient :</label>
                    <input type="text" class="form-control form-control-sm shadow-sm border border-1 border-info"
                        id="searchquery" placeholder="Search Patient..." wire:model="searchquery"   wire:model.live.debounce.300ms="searchquery" />
            ...
            @if ($patient)
                ...
                <div class="table-responsive">
                    <table id="patientstatementreport_id" class="table text-center table-hover m-0 p-0">
                        ...
                        <tbody>
                            @foreach ($patientstatement as $key => $item)
                                <tr>
                                    <td>{{ $patientstatement->firstItem() + $key }}</td>
