    ...
    <div class="card shadow-sm">
        <div class="card-header text-white theme_bg_color p-1">
            <div class="d-flex flex-row bd-highlight">
                <div class="flex-grow-1 bd-highlight mt-1"><span class="h5">IN PATIENT REPORT</span>
                </div>
                    ...
                    <tbody>
                        @foreach ($inpatient as $key => $item)
                            <tr>
                                ...
                                <td>{{ $item->patientvisit->reference->name ?? '-' }}</td>
                                <td>{{ $item->ipadmission->attender_name }}</td>
                                <td>{{ $item->ipadmission->attender_phone }}</td>
                                <td>{{ $item->ipadmission->creatable->name }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
