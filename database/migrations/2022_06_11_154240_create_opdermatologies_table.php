...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('opdermatologies', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('currentcomplaints_opdermatology', function (Blueprint $table) {
            $table->foreignIdFor(Currentcomplaints::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
            $table->foreignIdFor(Opdermatology::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
            $table->timestamps();
        ...
        Schema::create('opdermatology_physicalexam', function (Blueprint $table) {
        ...
        Schema::create('diagnosismaster_opdermatology', function (Blueprint $table) {
        ...
        Schema::create('labinvestigation_opdermatology', function (Blueprint $table) {
        ...
        Schema::create('scaninvestigation_opdermatology', function (Blueprint $table) {
            $table->foreignIdFor(Labinvestigation::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
        ...
        Schema::create('xrayinvestigation_opdermatology', function (Blueprint $table) {
            $table->foreignIdFor(Labinvestigation::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('opdermatologies');
    }
};
