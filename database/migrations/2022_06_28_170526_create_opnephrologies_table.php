...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('opnephrologies', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('currentcomplaints_opnephrology', function (Blueprint $table) {
            $table->foreignIdFor(Currentcomplaints::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
            $table->foreignIdFor(Opnephrology::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
            $table->timestamps();
        ...
        Schema::create('opnephrology_physicalexam', function (Blueprint $table) {
        ...
        Schema::create('diagnosismaster_opnephrology', function (Blueprint $table) {
        ...
        Schema::create('labinvestigation_opnephrology', function (Blueprint $table) {
        ...
        Schema::create('scaninvestigation_opnephrology', function (Blueprint $table) {
            $table->foreignIdFor(Labinvestigation::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
        ...
        Schema::create('xrayinvestigation_opnephrology', function (Blueprint $table) {
            $table->foreignIdFor(Labinvestigation::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('opnephrologies');
    }
};
