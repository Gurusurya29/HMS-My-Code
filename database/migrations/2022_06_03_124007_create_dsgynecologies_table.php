...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('dsgynecologies', function (Blueprint $table) {
            $table->id();
            // Dsgynecology Mother
            ...
            $table->text('natureofdelivery')->nullable();
            $table->json('babydetail')->nullable();
            $table->text('pih')->nullable();
            $table->text('postnatalperiod')->nullable();
            $table->text('medicinesgiven')->nullable();
    ...
    {
        Schema::dropIfExists('dsgynecologies');
    }
};
