...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('opgynecologies', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('abdominalexamination_note')->nullable();
            $table->string('nervoussystemexamination_note')->nullable();
            $table->string('perrectalexamination_note')->nullable();
            $table->string('pervaginalexamination_note')->nullable();

            $table->boolean('is_pallor', array(0, 1))->default(0);
            $table->boolean('is_cyanosis', array(0, 1))->default(0);
            $table->boolean('is_icterus', array(0, 1))->default(0);
            $table->boolean('is_clubbing', array(0, 1))->default(0);
            $table->boolean('is_pedaledema', array(0, 1))->default(0);
            $table->boolean('is_anasarca', array(0, 1))->default(0);
            $table->boolean('functional_assesment')->nullable();
        ...
        Schema::create('currentcomplaints_opgynecology', function (Blueprint $table) {
            $table->foreignIdFor(Currentcomplaints::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
            $table->foreignIdFor(Opgynecology::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
            $table->timestamps();
        ...
        Schema::create('opgynecology_physicalexam', function (Blueprint $table) {
        ...
        Schema::create('diagnosismaster_opgynecology', function (Blueprint $table) {
        ...
        Schema::create('labinvestigation_opgynecology', function (Blueprint $table) {
        ...
        Schema::create('scaninvestigation_opgynecology', function (Blueprint $table) {
            $table->foreignIdFor(Labinvestigation::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
        ...
        Schema::create('xrayinvestigation_opgynecology', function (Blueprint $table) {
            $table->foreignIdFor(Labinvestigation::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('opgynecologies');
    }
};
