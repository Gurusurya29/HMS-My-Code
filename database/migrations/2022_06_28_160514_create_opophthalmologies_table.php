...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('opophthalmologies', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('currentcomplaints_opophthalmology', function (Blueprint $table) {
            $table->foreignIdFor(Currentcomplaints::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
            $table->foreignIdFor(Opophthalmology::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
            $table->timestamps();
        ...
        Schema::create('opophthalmology_physicalexam', function (Blueprint $table) {
        ...
        Schema::create('diagnosismaster_opophthalmology', function (Blueprint $table) {
        ...
        Schema::create('labinvestigation_opophthalmology', function (Blueprint $table) {
        ...
        Schema::create('scaninvestigation_opophthalmology', function (Blueprint $table) {
            $table->foreignIdFor(Labinvestigation::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
        ...
        Schema::create('xrayinvestigation_opophthalmology', function (Blueprint $table) {
            $table->foreignIdFor(Labinvestigation::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('opophthalmologies');
    }
};
