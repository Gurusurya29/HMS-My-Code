...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('opanesthesiologies', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('currentcomplaints_opanesthesiology', function (Blueprint $table) {
            $table->foreignIdFor(Currentcomplaints::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
            $table->foreignIdFor(Opanesthesiology::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
            $table->timestamps();
        ...
        Schema::create('opanesthesiology_physicalexam', function (Blueprint $table) {
        ...
        Schema::create('diagnosismaster_opanesthesiology', function (Blueprint $table) {
        ...
        Schema::create('labinvestigation_opanesthesiology', function (Blueprint $table) {
        ...
        Schema::create('scaninvestigation_opanesthesiology', function (Blueprint $table) {
            $table->foreignIdFor(Labinvestigation::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
        ...
        Schema::create('xrayinvestigation_opanesthesiology', function (Blueprint $table) {
            $table->foreignIdFor(Labinvestigation::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('opanesthesiologies');
    }
};
