...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('opgeneralsurgeons', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('currentcomplaints_opgeneralsurgeon', function (Blueprint $table) {
            $table->foreignIdFor(Currentcomplaints::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
            $table->foreignIdFor(Opgeneralsurgeon::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
            $table->timestamps();
        ...
        Schema::create('opgeneralsurgeon_physicalexam', function (Blueprint $table) {
        ...
        Schema::create('diagnosismaster_opgeneralsurgeon', function (Blueprint $table) {
        ...
        Schema::create('labinvestigation_opgeneralsurgeon', function (Blueprint $table) {
        ...
        Schema::create('scaninvestigation_opgeneralsurgeon', function (Blueprint $table) {
            $table->foreignIdFor(Labinvestigation::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
        ...
        Schema::create('xrayinvestigation_opgeneralsurgeon', function (Blueprint $table) {
            $table->foreignIdFor(Labinvestigation::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('opgeneralsurgeonsurgeons');
    }
};
