...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('opdentals', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('treatmentplan_note')->nullable();
        ...
        Schema::create('currentcomplaints_opdental', function (Blueprint $table) {
            $table->foreignIdFor(Currentcomplaints::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
            $table->foreignIdFor(Opdental::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
            $table->timestamps();
        ...
        Schema::create('opdental_physicalexam', function (Blueprint $table) {
        ...
        Schema::create('diagnosismaster_opdental', function (Blueprint $table) {
