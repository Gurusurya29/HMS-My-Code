...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('opurologies', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('currentcomplaints_opurology', function (Blueprint $table) {
            $table->foreignIdFor(Currentcomplaints::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
            $table->foreignIdFor(Opurology::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
            $table->timestamps();
        ...
        Schema::create('opurology_physicalexam', function (Blueprint $table) {
        ...
        Schema::create('diagnosismaster_opurology', function (Blueprint $table) {
        ...
        Schema::create('labinvestigation_opurology', function (Blueprint $table) {
        ...
        Schema::create('scaninvestigation_opurology', function (Blueprint $table) {
            $table->foreignIdFor(Labinvestigation::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
        ...
        Schema::create('xrayinvestigation_opurology', function (Blueprint $table) {
            $table->foreignIdFor(Labinvestigation::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('opurologies');
    }
};
