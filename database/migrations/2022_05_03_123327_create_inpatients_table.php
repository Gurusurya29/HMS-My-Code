...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('inpatients', function (Blueprint $table) {
            ...
            $table->foreignIdFor(Outpatient::class)->nullable(); // If moved from OP

            $table->nullableMorphs('dsspecialable');
            $table->boolean('is_movedto_ot')->default(0);
            $table->timestamp('is_patientdischarged')->nullable();
