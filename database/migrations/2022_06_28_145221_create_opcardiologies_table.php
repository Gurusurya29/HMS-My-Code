...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('opcardiologies', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('currentcomplaints_opcardiology', function (Blueprint $table) {
            $table->foreignIdFor(Currentcomplaints::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
            $table->foreignIdFor(Opcardiology::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
            $table->timestamps();
        ...
        Schema::create('opcardiology_physicalexam', function (Blueprint $table) {
        ...
        Schema::create('diagnosismaster_opcardiology', function (Blueprint $table) {
        ...
        Schema::create('labinvestigation_opcardiology', function (Blueprint $table) {
        ...
        Schema::create('scaninvestigation_opcardiology', function (Blueprint $table) {
            $table->foreignIdFor(Labinvestigation::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
        ...
        Schema::create('xrayinvestigation_opcardiology', function (Blueprint $table) {
            $table->foreignIdFor(Labinvestigation::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('opcardiologies');
    }
};
