...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('opsonologies', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('currentcomplaints_opsonology', function (Blueprint $table) {
            $table->foreignIdFor(Currentcomplaints::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
            $table->foreignIdFor(Opsonology::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
            $table->timestamps();
        ...
        Schema::create('opsonology_physicalexam', function (Blueprint $table) {
        ...
        Schema::create('diagnosismaster_opsonology', function (Blueprint $table) {
        ...
        Schema::create('labinvestigation_opsonology', function (Blueprint $table) {
        ...
        Schema::create('scaninvestigation_opsonology', function (Blueprint $table) {
            $table->foreignIdFor(Labinvestigation::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
        ...
        Schema::create('xrayinvestigation_opsonology', function (Blueprint $table) {
            $table->foreignIdFor(Labinvestigation::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('opsonologies');
    }
};
