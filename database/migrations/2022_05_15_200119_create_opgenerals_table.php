...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('opgenerals', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('currentcomplaints_opgeneral', function (Blueprint $table) {
            $table->foreignIdFor(Currentcomplaints::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
            $table->foreignIdFor(Opgeneral::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
            $table->timestamps();
        ...
        Schema::create('opgeneral_physicalexam', function (Blueprint $table) {
        ...
        Schema::create('diagnosismaster_opgeneral', function (Blueprint $table) {
        ...
        Schema::create('labinvestigation_opgeneral', function (Blueprint $table) {
        ...
        Schema::create('scaninvestigation_opgeneral', function (Blueprint $table) {
            $table->foreignIdFor(Labinvestigation::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
        ...
        Schema::create('xrayinvestigation_opgeneral', function (Blueprint $table) {
            $table->foreignIdFor(Labinvestigation::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('opgenerals');
    }
};
