...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('oporthopedics', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('currentcomplaints_oporthopedic', function (Blueprint $table) {
            $table->foreignIdFor(Currentcomplaints::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
            $table->foreignIdFor(Oporthopedic::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
            $table->timestamps();
        ...
        Schema::create('oporthopedic_physicalexam', function (Blueprint $table) {
        ...
        Schema::create('diagnosismaster_oporthopedic', function (Blueprint $table) {
        ...
        Schema::create('labinvestigation_oporthopedic', function (Blueprint $table) {
        ...
        Schema::create('scaninvestigation_oporthopedic', function (Blueprint $table) {
            $table->foreignIdFor(Labinvestigation::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
        ...
        Schema::create('xrayinvestigation_oporthopedic', function (Blueprint $table) {
            $table->foreignIdFor(Labinvestigation::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('oporthopedics');
    }
};
