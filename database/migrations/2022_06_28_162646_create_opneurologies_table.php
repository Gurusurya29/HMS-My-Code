...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('opneurologies', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('currentcomplaints_opneurology', function (Blueprint $table) {
            $table->foreignIdFor(Currentcomplaints::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
            $table->foreignIdFor(Opneurology::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
            $table->timestamps();
        ...
        Schema::create('opneurology_physicalexam', function (Blueprint $table) {
        ...
        Schema::create('diagnosismaster_opneurology', function (Blueprint $table) {
        ...
        Schema::create('labinvestigation_opneurology', function (Blueprint $table) {
        ...
        Schema::create('scaninvestigation_opneurology', function (Blueprint $table) {
            $table->foreignIdFor(Labinvestigation::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
        ...
        Schema::create('xrayinvestigation_opneurology', function (Blueprint $table) {
            $table->foreignIdFor(Labinvestigation::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('opneurologies');
    }
};
