...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('scanpatientlists', function (Blueprint $table) {
            $table->id();
            $table->foreignIdFor(Scanpatient::class);
            ...
            $table->string('scaninvestigation_name');
            $table->string('scaninvestigationgroup_name');
    ...
    {
        Schema::dropIfExists('scanpatientlists');
    }
};
