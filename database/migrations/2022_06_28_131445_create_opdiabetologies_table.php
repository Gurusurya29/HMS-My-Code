...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('opdiabetologies', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('currentcomplaints_opdiabetology', function (Blueprint $table) {
            $table->foreignIdFor(Currentcomplaints::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
            $table->foreignIdFor(Opdiabetology::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
            $table->timestamps();
        ...
        Schema::create('opdiabetology_physicalexam', function (Blueprint $table) {
        ...
        Schema::create('diagnosismaster_opdiabetology', function (Blueprint $table) {
        ...
        Schema::create('labinvestigation_opdiabetology', function (Blueprint $table) {
        ...
        Schema::create('scaninvestigation_opdiabetology', function (Blueprint $table) {
            $table->foreignIdFor(Labinvestigation::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
        ...
        Schema::create('xrayinvestigation_opdiabetology', function (Blueprint $table) {
            $table->foreignIdFor(Labinvestigation::class)
                ->constrained()
                ->onUpdate('cascade')
                ->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('opdiabetologies');
    }
};
